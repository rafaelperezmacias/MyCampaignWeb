...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Administradores de la campaña</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12 text-right">
                    <h1><a href="{{ route('administrators.create') }}" type="reset" class="btn btn-outline-primary align-bottom pl-5 pr-5">Agregar administrador</a></h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
